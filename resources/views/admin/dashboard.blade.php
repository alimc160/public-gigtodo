                    ...
                    <div class="card-header bg-primary">
                        ...
                        <div class="row">
                            ...
                            <div class="col-9 text-right">
                                ...
                                <div class="huge">
                                    0 <span class="badge badge-danger">Proposals</span>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="mx-auto d-block">
                            ...
                            <img class="rounded-circle mx-auto d-block" src="http://localhost/gigtodo/GigToDo_Freelance_Marketplace_153_TRC4_EDIT///admin/admin_images/black.png" alt="Card image cap" width="145px">



                            <h5 class="text-sm-center mt-2 mb-1">ADMIN</h5>
                            <div class="location text-sm-center"><i class="fa fa-map-marker"></i> ALBANIA</div>
                        </div>
                        <hr>
                        <div class="card-text text-sm-center">
                            <span class="badge badge-success">PHP FRAMEWORK</span>
                        </div>
                    </div>
                </div>
            </div>
